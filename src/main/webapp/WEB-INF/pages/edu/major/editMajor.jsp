...
<body style="background-color: #fff">
	...
	<input type="hidden" id="id" value="${major.id }" name="major.id" />
	<input type="hidden" id="hiddenMajorName" value="${major.majorName }" name="hiddenMajorName" />
		...
		<div class="cell">
			<table border="0" cellpadding="0" cellspacing="0">
		       <tr>
		            ...
		            <td style="width:35%;">
		            	<input type="text" value="${major.majorName}" id="majorName" name="major.majorName" class="form_text" maxlength="25" reg="Require" tip="请填写专业名称"/>
		            </td>
		       </tr> 
		       <tr>
		        	<th><span style="color: red;">*</span>专业编码：</th>
		            <td><input type="text"  value="${major.majorCode}" name="major.majorCode" id="majorCode" class="form_text" maxlength="25"  reg="Require" tip="请填写专业编码"/></td>
		       </tr>
		       <tr>
		        	<th><span style="color: red;">*</span>所属系部：</th>
		            <td>
		            	<select id="departmentId" name="major.department.id" style="width:90%">
		       ...
		       <tr>
		       		<th>排序号：</th>
		            <td><input type="text"  value="${major.sn}" name="major.sn" class="form_text" reg="NullOrNum" tip="请填写数字格式的排序号" /></td>
		       </tr> 
	...
	<script type="text/javascript">
		$(function(){ 
			...
			$("#departmentId").val('${major.department.id}');	
		});
	</script>
</body>
</html>