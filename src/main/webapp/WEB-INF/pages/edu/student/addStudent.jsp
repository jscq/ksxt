...
<body style="background-color: #fff">
		...
		<input type='hidden' id='documentName' name='documentName' />
			...
			<table border="0" cellpadding="0" cellspacing="0">
				<tr>
		            ...
		            <th width="12%" rowspan="6">照片：</th>
		            <td width="21%" rowspan="6" align="center">
		       ...
		       <tr>
		            ...
		            <td width="21%">
		       		...
		       		<th width="12%">出生年月：</th>
		            <td width="21%"><input class='Wdate form_text' id="birthDate" name="commissioner.birthDate" type='text' class="form_text" placeholder="请选择出生年月" onClick='WdatePicker()' readonly="readonly"/></td>
		       </tr>
		       <tr>
		            <th width="12%">身份证号：</th>
		       ...
		       <tr>
		       		<th width="12%">入学年份：</th>
		            <td width="21%">
						<select id="year" name="year" onChange="selectMajor(this.value)" class="form_text" placeholder="请选择系部">
						</select>
					</td>
					
		       		<th width="12%">系部：</th>
		            <td width="21%">
						<select id="department" name="commissioner.department" onChange="checkMajor(this.value)" class="form_text" placeholder="请选择系部">
							<option value="">--请选择--</option>
             		
             				<c:forEach items="${departmentList}" var="code" >  
			       	 			<option value="${code.id}">--${code.departmentName}--</option>
			       			</c:forEach>  
						</select>
					</td>
		       </tr>
		       <tr>
					<th width="12%">专业：</th>
		            <td width="21%">
						<select id="major" name="commissioner.politicsStatus" onChange="checkClassRomm(this.value)" class="form_text" placeholder="请选择专业">
		       		...
		       		<th width="12%">班级：</th>
		            <td width="21%">
						<select id="classRomm" name="commissioner.politicsStatus" class="form_text" placeholder="请选择政治面貌"></select>
					</td>
		       </tr>
				...
				<tr>
		            ...
		            <td width="12%" colspan="2">
						<input type="text" name="commissioner.phone" class="form_text" reg="NullOrPhone" tip="联系电话格式错误，请重新填写" placeholder="请填写详细地址" maxlength="20"/>
					</td>
		       </tr>
		   	</table>
		   	</div>
		   	...
		   	<div class="box_03">
	        	<div class="box_inner_03">
	        		<div class="btn_area_setl btn_area_bg">
	        			<a href="#" onclick="saveCommissioner('commissionerForm','${_csrf.parameterName}','${_csrf.token}')" class="btn_01">保存学生信息<b></b></a>
	...
	<div id="showPic" class="easyui-window" style="width: 400px;height: 200px;text-align:center;padding-top:20px;">
		<form id='uploadForm' action='<%=basePath%>/uploadFile/uploadPicMethod?picPath=studentUploadPic&${_csrf.parameterName}=${_csrf.token}' method='POST' enctype='multipart/form-data'>
			<table class="cell" >
				<tr>
