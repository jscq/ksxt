...
<body style="background-color: #fff">
	...
	<input type="hidden" id="hiddenFuncName" value="${function.funcName }" name="hiddenFuncName" />
		
		<div class="cell">
			<table border="0" cellpadding="0" cellspacing="0">
		       <tr>
		        	<th><span style="color: red;">*</span>功能名称：</th>
		            <td><input type="text" id="funcName" value="${function.funcName }" name="function.funcName" class="form_text" maxlength="25" reg="Require" tip="请填写功能名称" /></td>
		            
		            <th>链接地址：</th>
		            <td><input type="text" value="${function.linkUrl }" name="function.linkUrl" class="form_text"/></td>
		       </tr> 
		       <tr>
		        	<th>功能编码：</th>
		            <td><input type="text" value="${function.funcCode }" name="function.funcCode" class="form_text" maxlength="25"/></td>
