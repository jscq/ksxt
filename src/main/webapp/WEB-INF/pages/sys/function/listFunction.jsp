		...
		<div class="cell">
	           ...
	           <tr>
	             ...
	             <td width="23%">
					...
					<input onkeydown="if(event.keyCode==13){event.keyCode=0;return false}" type="text" id="funcTree" class="form_text" style="width:245px;"/>
	             </td>
	             <th width="10%">功能名称：</th>
	             <td width="23%"><input onkeydown="if(event.keyCode==13){event.keyCode=0;return false}" id="funcName" name="function.funcName" class="form_text" maxlength="50"/></td>
	             <th width="10%">功能编码：</th>
	             <td width="23%"><input onkeydown="if(event.keyCode==13){event.keyCode=0;return false}" id="funcCode" name="function.funcCode" class="form_text" maxlength="50"/></td>
	           </tr>
	       	</table>
     	</div>
		<ul>
...
$(function(){
	...
	$('#dg').datagrid({
		...
		queryParams:{
			'function.funcName':$('#funcName').val(), // 功能名称
			'function.funcCode':$('#funcCode').val(), // 功能编码
		...
		columns:[[
			...
			{field:'funcName',title:'功能名称',width:'18%',sortable:true},
			{field:'funcCode',title:'功能编码',width:'18%',sortable:true},
			{field:'linkUrl',title:'链接地址',width:'18%',sortable:true},
